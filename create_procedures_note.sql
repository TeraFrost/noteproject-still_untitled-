...
drop procedure update_note;
 delimiter ^^ 
  create procedure update_note(id_ int,name_ char(32),text_ text,id_im int,id_u int,start_d datetime)
     begin
    ...
    SET MESSAGE_TEXT = 'id_task and id_user are null';
     ...
     update note 
      set name=name_,text_note=text_,start_date= start_d,id_importance=id_im,id_user=id_u
       where id=id_;
     end ^^
